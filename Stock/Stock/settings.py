...
# See https://docs.djangoproject.com/en/5.2/deployment/checklist/

SECRET_KEY = 'django-insecure-h$b4(&p9%$tyb_yci^)7zrx8*mv(0x&ozp(r0o%-yd#y$6x+0j'
# TODO: Change this in production to a secure secret key
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'Africa/Nairobi'  # Updated for your timezone
USE_I18N = True
USE_TZ = True
